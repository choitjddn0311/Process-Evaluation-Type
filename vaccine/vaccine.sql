...
//예방접종통계
select v.vaccine_code, v.infectious_disease, v.vaccines, count(n.vaccine_code) 
from tbl_vaccine v, tbl_vaccination n
where v.vaccine_code=n.vaccine_code 
group by v.vaccine_code, v.infectious_disease, v.vaccines
order by v.vaccine_code;
//예방접종이력조회
select n.vaccinate_no,n.people_id,p.people_name,n.vaccine_code,v.vaccines,v.vaccine_recommendation,n.vaccinate_date,n.vaccinate_round,n.vaccinate_result,i.institutional_name
from tbl_vaccination n, tbl_people p,tbl_vaccine v,tbl_institutional i
where n.people_id=p.people_id 
and n.vaccine_code=v.vaccine_code
and n.visit_agency=i.visit_agency
order by n.vaccinate_no;